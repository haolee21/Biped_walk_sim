function out1 = Tau_heel_6(in1,in2,Fx,H,k,cmax,dmax,sampT)
%TAU_HEEL_6
%    OUT1 = TAU_HEEL_6(IN1,IN2,FX,H,K,CMAX,DMAX,SAMPT)

%    This function was generated by the Symbolic Math Toolbox version 8.5.
%    23-Jan-2021 20:18:53
...
out1 = Fx.*t47.*cos(t50).*(-5.329070518200751e-20)-t47.*t51.*(k.*t73.^2+(cmax.*t73.*(qd_t2.*(t31+t63)+qd_t5.*(t38+t62)+qd_t3.*t63+qd_t4.*t63+qd_t1.*(t2.*4.5018e-1+t31+t63)-qd_t6.*t47.*t51.*5.329070518200751e-20))./dmax).*5.329070518200751e-20;
