function out1 = Tau_toe_6(in1,in2,Fx,H,k,cmax,dmax,sampT)
%TAU_TOE_6
%    OUT1 = TAU_TOE_6(IN1,IN2,FX,H,K,CMAX,DMAX,SAMPT)

%    This function was generated by the Symbolic Math Toolbox version 8.5.
%    22-Jan-2021 22:44:33
...
out1 = t61.*(k.*t70.^2+(cmax.*t70.*(qd_t2.*(t31+t62)+qd_t5.*(t38+t61)+qd_t3.*t62+qd_t4.*t62+qd_t6.*t61+qd_t1.*(t2.*4.5018e-1+t31+t62)))./dmax)-(Fx.*t47.*cos(q_t6+t23-atan(2.165415384615385)))./7.0368744177664e+18;
