dynConst_discrete MATLAB Python Package
...
2. Installing the dynConst_discrete Package

A. Change to the directory that contains the file setup.py and the subdirectory 
dynConst_discrete. If you do not have write permissions, copy all its contents to a 
...
3. Using the dynConst_discrete Package

The dynConst_discrete package is on your Python path. To import it into a Python script 
or session, execute:

    import dynConst_discrete
