function output = batch_sim_single(model,modelType,hipLen,h,w,knee_dir,gaitT,hipLen_idx)
%%
...
res = opt_discrete(model,modelType,hipLen,h,w,0.12,gaitT,knee_dir,hipLen_idx);
