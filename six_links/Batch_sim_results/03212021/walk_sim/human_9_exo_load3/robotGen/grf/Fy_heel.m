...
Fy_heel = k.*t73.^2+(cmax.*t73.*(qd_t2.*(t31+t63)+qd_t5.*(t38+t62)+qd_t3.*t63+qd_t4.*t63+qd_t1.*(t2.*4.5018e-1+t31+t63)-qd_t6.*t47.*t51.*5.329070518200751e-20))./dmax;
