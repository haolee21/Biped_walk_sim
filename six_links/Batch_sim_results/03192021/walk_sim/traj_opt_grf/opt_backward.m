...
param.hip_feet_ratio = 2.8/0.7143;
...
ubq = [179.9/180*pi*ones(1,param.varDim.q2)/param.q_scale;
      179.99*180/pi*ones(1,param.varDim.q2)/param.q_scale;
