...
#echo "matlab -nojvm -nodisplay -nosplash -r IDRE_WTFaACLu -logfile IDRE_WTFaACLu.output.$JOB_ID"
#echo " "
#matlab -nojvm -nodisplay -nosplash -r IDRE_WTFaACLu -logfile IDRE_WTFaACLu.output.$JOB_ID
#echo " "

echo "matlab -nodisplay -nosplash -r IDRE_WTFaACLu -logfile batch_sim6.output.$JOB_ID"
echo " "
matlab -nodisplay -nosplash -r IDRE_WTFaACLu -logfile batch_sim6.output.$JOB_ID
echo " "
