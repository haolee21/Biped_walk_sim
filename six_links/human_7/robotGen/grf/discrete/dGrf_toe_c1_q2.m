...
t153 = cmax.*t140.*t151;
t156 = (cmax.*t20.*t141.*t142.*t150)./2.0;
t154 = -t153;
t157 = t154+t155+t156;
t158 = (s.*t157)./2.0;
t159 = t152+t158;
dGrf_toe_c1_q2 = [(s.*(k.*t145.*(-t47+t58+t61+t143).*2.0-cmax.*t151.*(t89+t103+t110+t111+t137+qd_t1.*(t48+t134))+(cmax.*t20.*t141.*t150.*(t2.*(-9.201240000000001e-1)+t59+t60+t142))./2.0))./2.0+cmax.*s.*t21.*t138.*t151;(s.*(-cmax.*t151.*(t89+t103+t110+t111+t137+qd_t1.*t134)+k.*t145.*(t58+t61+t143).*2.0+(cmax.*t20.*t141.*t150.*(t59+t60+t142))./2.0))./2.0+cmax.*s.*t21.*t135.*t151;t159;t159;(s.*(k.*t145.*(t92+t99+t115+t123+t126+t133).*2.0-cmax.*t151.*(t89+t103+qd_t1.*t101+qd_t2.*t101+qd_t3.*t101+qd_t4.*t101)+(cmax.*t20.*t141.*t150.*(t93+t98+t114+t122+t127+t132))./2.0))./2.0+cmax.*s.*t21.*t100.*t151;(s.*(-cmax.*t151.*(t89+qd_t1.*t87+qd_t2.*t87+qd_t3.*t87+qd_t4.*t87+qd_t5.*t87)+k.*t145.*(t115+t123+t126+t133).*2.0+(cmax.*t20.*t141.*t150.*(t114+t122+t127+t132))./2.0))./2.0+cmax.*s.*t21.*t86.*t151];
