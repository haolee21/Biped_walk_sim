...
Grf_toe_c2 = Fx.^2-us.^2.*(k.*t68.^2+(cmax.*t68.*(qd_t2.*(t41+t62)+qd_t5.*(t46+t57)+qd_t6.*t57+qd_t3.*t62+qd_t4.*t62+qd_t1.*(t2.*4.60062e-1+t41+t62)))./dmax).^2;
