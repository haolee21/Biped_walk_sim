function Human_Exo_main(modelName,modelType,extra_load,exo_enable,totH,totM,gen_grf)
...
model.totH = totH;
save(['../',modelName,'/',modelType,'/robotGen/model.mat'],'model');
...
tasks{1,1} =@()matlabFunction(dL1_F(1,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL1_1'],'vars',{q,dq,sampT}); 
tasks{1,2} =@()matlabFunction(dL1_F(2,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL1_2'],'vars',{q,dq,sampT}); 
tasks{1,3} =@()matlabFunction(dL1_F(3,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL1_3'],'vars',{q,dq,sampT}); 
tasks{1,4} =@()matlabFunction(dL1_F(4,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL1_4'],'vars',{q,dq,sampT});
tasks{1,5} =@()matlabFunction(dL1_F(5,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL1_5'],'vars',{q,dq,sampT}); 
tasks{1,6} =@()matlabFunction(dL1_F(6,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL1_6'],'vars',{q,dq,sampT}); 


tasks{1,7} =@()matlabFunction(dL2_F(1,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL2_1'],'vars',{q,dq,sampT});
tasks{1,8} =@()matlabFunction(dL2_F(2,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL2_2'],'vars',{q,dq,sampT}); 
tasks{1,9} =@()matlabFunction(dL2_F(3,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL2_3'],'vars',{q,dq,sampT}); 
tasks{1,10} =@()matlabFunction(dL2_F(4,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL2_4'],'vars',{q,dq,sampT});
tasks{1,11} =@()matlabFunction(dL2_F(5,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL2_5'],'vars',{q,dq,sampT});
tasks{1,12} =@()matlabFunction(dL2_F(6,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/forward/dL2_6'],'vars',{q,dq,sampT}); 


tasks{1,13} =@()matlabFunction(dL1_B(1,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL1_1'],'vars',{q,dq,sampT}); 
tasks{1,14} =@()matlabFunction(dL1_B(2,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL1_2'],'vars',{q,dq,sampT}); 
tasks{1,15} =@()matlabFunction(dL1_B(3,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL1_3'],'vars',{q,dq,sampT}); 
tasks{1,16} =@()matlabFunction(dL1_B(4,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL1_4'],'vars',{q,dq,sampT}); 
tasks{1,17} =@()matlabFunction(dL1_B(5,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL1_5'],'vars',{q,dq,sampT});
tasks{1,18} =@()matlabFunction(dL1_B(6,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL1_6'],'vars',{q,dq,sampT}); 


tasks{1,19} =@()matlabFunction(dL2_B(1,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL2_1'],'vars',{q,dq,sampT}); 
tasks{1,20} =@()matlabFunction(dL2_B(2,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL2_2'],'vars',{q,dq,sampT}); 
tasks{1,21} =@()matlabFunction(dL2_B(3,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL2_3'],'vars',{q,dq,sampT}); 
tasks{1,22} =@()matlabFunction(dL2_B(4,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL2_4'],'vars',{q,dq,sampT});
tasks{1,23} =@()matlabFunction(dL2_B(5,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL2_5'],'vars',{q,dq,sampT}); 
tasks{1,24} =@()matlabFunction(dL2_B(6,1),'file',['../',modelName,'/',modelType,'/robotGen/dyn/backward/dL2_6'],'vars',{q,dq,sampT}); 
...
tasks6=cell(1,10);
tasks6{1,1} =@()matlabFunction(Fy_toe,'file',['../',modelName,'/grf/Fy_toe'],'vars',{q,dq,H,k,cmax,dmax,sampT}); 
tasks6{1,2} =@()matlabFunction(Fy_heel,'file',['../',modelName,'/grf/Fy_heel'],'vars',{q,dq,H,k,cmax,dmax,sampT}); 
...
tasks6{1,3} =@()matlabFunction(dFy_toe_q1,'file',['../',modelName,'/grf/dFy_toe1'],'vars',{q,dq,H,k,cmax,dmax,sampT}); 
tasks6{1,4} =@()matlabFunction(dFy_toe_q2,'file',['../',modelName,'/grf/dFy_toe2'],'vars',{q,dq,H,k,cmax,dmax,sampT}); 
...
tasks6{1,5} =@()matlabFunction(dFy_heel_q1,'file',['../',modelName,'/grf/dFy_heel1'],'vars',{q,dq,H,k,cmax,dmax,sampT}); 
tasks6{1,6} =@()matlabFunction(dFy_heel_q2,'file',['../',modelName,'/grf/dFy_heel2'],'vars',{q,dq,H,k,cmax,dmax,sampT}); 
...
tasks6{1,7} =@()matlabFunction(Tau_toe_pushoff,'file',['../',modelName,'/grf/Tau_toe_pushoff'],'vars',{q,dq,Fx,Fy,H,k,cmax,dmax,sampT}); 
tasks6{1,8} =@()matlabFunction(dTau_toe_pushoff_dq1,'file',['../',modelName,'/grf/dTau_toe_pushoff_dq1'],'vars',{q,dq,Fx,Fy,H,k,cmax,dmax,sampT}); 
tasks6{1,9} =@()matlabFunction(dTau_toe_pushoff_dq2,'file',['../',modelName,'/grf/dTau_toe_pushoff_dq2'],'vars',{q,dq,Fx,Fy,H,k,cmax,dmax,sampT}); 
tasks6{1,10} =@()matlabFunction(dTau_toe_pushoff_dfx,'file',['../',modelName,'/grf/dTau_toe_pushoff_dfx'],'vars',{q,dq,Fx,Fy,H,k,cmax,dmax,sampT});
tasks6{1,11} =@()matlabFunction(dTau_toe_pushoff_dfy,'file',['../',modelName,'/grf/dTau_toe_pushoff_dfy'],'vars',{q,dq,Fx,Fy,H,k,cmax,dmax,sampT});
...
tasks6{1,12} =@()matlabFunction(Grf_toe_c1,'file',['../',modelName,'/grf/Grf_toe_c1'],'vars',{q,dq,Fx,H,k,cmax,dmax,us}); 
tasks6{1,13} =@()matlabFunction(Grf_heel_c1,'file',['../',modelName,'/grf/Grf_heel_c1'],'vars',{q,dq,Fx,H,k,cmax,dmax,us}); 

tasks6{1,14} =@()matlabFunction(dGrf_toe_c1_dq1,'file',['../',modelName,'/grf/dGrf_toe_c1_dq1'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,15} =@()matlabFunction(dGrf_toe_c1_dq2,'file',['../',modelName,'/grf/dGrf_toe_c1_dq2'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,16} =@()matlabFunction(dGrf_toe_c1_dfx,'file',['../',modelName,'/grf/dGrf_toe_c1_dfx'],'vars',Fx); 

tasks6{1,17} =@()matlabFunction(dGrf_heel_c1_dq1,'file',['../',modelName,'/grf/dGrf_heel_c1_dq1'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,18} =@()matlabFunction(dGrf_heel_c1_dq2,'file',['../',modelName,'/grf/dGrf_heel_c1_dq2'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,19} =@()matlabFunction(dGrf_heel_c1_dfx,'file',['../',modelName,'/grf/dGrf_heel_c1_dfx'],'vars',Fx); 

tasks6{1,20} =@()matlabFunction(Grf_toe_c2,'file',['../',modelName,'/grf/Grf_toe_c2'],'vars',{q,dq,Fx,H,k,cmax,dmax,us}); 
tasks6{1,21} =@()matlabFunction(Grf_heel_c2,'file',['../',modelName,'/grf/Grf_heel_c2'],'vars',{q,dq,Fx,H,k,cmax,dmax,us}); 

tasks6{1,22} =@()matlabFunction(dGrf_toe_c2_dq1,'file',['../',modelName,'/grf/dGrf_toe_c2_dq1'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,23} =@()matlabFunction(dGrf_toe_c2_dq2,'file',['../',modelName,'/grf/dGrf_toe_c2_dq2'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,24} =@()matlabFunction(dGrf_toe_c2_dfx,'file',['../',modelName,'/grf/dGrf_toe_c2_dfx'],'vars',Fx); 

tasks6{1,25} =@()matlabFunction(dGrf_heel_c2_dq1,'file',['../',modelName,'/grf/dGrf_heel_c2_dq1'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,26} =@()matlabFunction(dGrf_heel_c2_dq2,'file',['../',modelName,'/grf/dGrf_heel_c2_dq2'],'vars',{q,dq,H,k,cmax,dmax,us,sampT}); 
tasks6{1,27} =@()matlabFunction(dGrf_heel_c2_dfx,'file',['../',modelName,'/grf/dGrf_heel_c2_dfx'],'vars',Fx); 
...
tasks6{1,28}=@()matlabFunction(Grf_toe_c4,'file',['../',modelName,'/grf/Grf_toe_c4'],'vars',{q,dq,Fx}); 
tasks6{1,29}=@()matlabFunction(Grf_heel_c4,'file',['../',modelName,'/grf/Grf_heel_c4'],'vars',{q,dq,Fx}); 
...
tasks6{1,30}=@()matlabFunction(dGrf_toe_c4_q1,'file',['../',modelName,'/grf/dGrf_toe_c4_q1'],'vars',{q,dq,Fx,sampT});
tasks6{1,31}=@()matlabFunction(dGrf_toe_c4_q2,'file',['../',modelName,'/grf/dGrf_toe_c4_q2'],'vars',{q,dq,Fx,sampT}); 

tasks6{1,32}=@()matlabFunction(dGrf_heel_c4_q1,'file',['../',modelName,'/grf/dGrf_heel_c4_q1'],'vars',{q,dq,Fx,sampT}); 
tasks6{1,33}=@()matlabFunction(dGrf_heel_c4_q2,'file',['../',modelName,'/grf/dGrf_heel_c4_q2'],'vars',{q,dq,Fx,sampT}); 

dGrf_toe_c4_Fx = diff(Grf_toe_c4,Fx);
                 
dGrf_heel_c4_Fx = diff(Grf_heel_c4,Fx);
              
tasks6{1,34}=@()matlabFunction(dGrf_toe_c4_Fx,'file',['../',modelName,'/grf/dGrf_toe_c4_F'],'vars',{q,dq}); 
tasks6{1,35}=@()matlabFunction(dGrf_heel_c4_Fx,'file',['../',modelName,'/grf/dGrf_heel_c4_F'],'vars',{q,dq}); 
...
tasks6{1,36}=@()matlabFunction(hip_vel_x ,'file',['../',modelName,'/pos/hip_vel_x'],'vars',{q,dq,sampT}); 
tasks6{1,37}=@()matlabFunction(dHip_vel_q1,'file',['../',modelName,'/pos/dHip_vel_q1'],'vars',{q,dq,sampT}); 
tasks6{1,38}=@()matlabFunction(dHip_vel_q2,'file',['../',modelName,'/pos/dHip_vel_q2'],'vars',{q,dq,sampT}); 
...
tasks = cell(1,24);
tasks{1,1} =@()matlabFunction(dL11_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL11_dq1'],'vars',{q,dq,sampT}); 
tasks{1,2} =@()matlabFunction(dL12_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL12_dq1'],'vars',{q,dq,sampT});
tasks{1,3} =@()matlabFunction(dL13_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL13_dq1'],'vars',{q,dq,sampT});
tasks{1,4} =@()matlabFunction(dL14_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL14_dq1'],'vars',{q,dq,sampT}); 
tasks{1,5} =@()matlabFunction(dL15_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL15_dq1'],'vars',{q,dq,sampT});
tasks{1,6} =@()matlabFunction(dL16_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL16_dq1'],'vars',{q,dq,sampT}); 

tasks{1,7} =@()matlabFunction(dL11_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL11_dq2'],'vars',{q,dq,sampT});
tasks{1,8} =@()matlabFunction(dL12_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL12_dq2'],'vars',{q,dq,sampT}); 
tasks{1,9} =@()matlabFunction(dL13_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL13_dq2'],'vars',{q,dq,sampT}); 
tasks{1,10} =@()matlabFunction(dL14_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL14_dq2'],'vars',{q,dq,sampT});
tasks{1,11} =@()matlabFunction(dL15_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL15_dq2'],'vars',{q,dq,sampT}); 
tasks{1,12} =@()matlabFunction(dL16_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL16_dq2'],'vars',{q,dq,sampT}); 

tasks{1,13} =@()matlabFunction(dL21_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL21_dq1'],'vars',{q,dq,sampT});
tasks{1,14} =@()matlabFunction(dL22_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL22_dq1'],'vars',{q,dq,sampT}); 
tasks{1,15} =@()matlabFunction(dL23_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL23_dq1'],'vars',{q,dq,sampT});
tasks{1,16} =@()matlabFunction(dL24_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL24_dq1'],'vars',{q,dq,sampT}); 
tasks{1,17} =@()matlabFunction(dL25_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL25_dq1'],'vars',{q,dq,sampT});
tasks{1,18} =@()matlabFunction(dL26_dq1,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL26_dq1'],'vars',{q,dq,sampT});

tasks{1,19} =@()matlabFunction(dL21_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL21_dq2'],'vars',{q,dq,sampT}); 
tasks{1,20} =@()matlabFunction(dL22_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL22_dq2'],'vars',{q,dq,sampT}); 
tasks{1,21} =@()matlabFunction(dL23_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL23_dq2'],'vars',{q,dq,sampT}); 
tasks{1,22} =@()matlabFunction(dL24_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL24_dq2'],'vars',{q,dq,sampT}); 
tasks{1,23} =@()matlabFunction(dL25_dq2,'file',['../',modelName,'/',modelType,'/robotGen/dyn/',knee_config,'/dL25_dq2'],'vars',{q,dq,sampT});
