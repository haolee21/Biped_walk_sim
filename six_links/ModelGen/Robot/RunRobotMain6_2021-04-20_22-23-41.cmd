...
#echo "matlab -nojvm -nodisplay -nosplash -r IDRE_ZlndwxMX -logfile IDRE_ZlndwxMX.output.$JOB_ID"
#echo " "
#matlab -nojvm -nodisplay -nosplash -r IDRE_ZlndwxMX -logfile IDRE_ZlndwxMX.output.$JOB_ID
#echo " "

echo "matlab -nodisplay -nosplash -r IDRE_ZlndwxMX -logfile RunRobotMain6.output.$JOB_ID"
echo " "
matlab -nodisplay -nosplash -r IDRE_ZlndwxMX -logfile RunRobotMain6.output.$JOB_ID
echo " "
