...
Grf_heel_c2 = Fx.^2-us.^2.*(k.*t73.^2+(cmax.*t73.*(dq2.*(t31+t63)+dq5.*(t38+t62)+dq3.*t63+dq4.*t63+dq1.*(t2.*4.4835e-1+t31+t63)-dq6.*t47.*t51.*5.329070518200751e-20))./dmax).^2;
