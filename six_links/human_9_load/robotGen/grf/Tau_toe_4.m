function out1 = Tau_toe_4(in1,in2,Fx,H,k,cmax,dmax,sampT)
%TAU_TOE_4
%    OUT1 = TAU_TOE_4(IN1,IN2,FX,H,K,CMAX,DMAX,SAMPT)

%    This function was generated by the Symbolic Math Toolbox version 8.5.
%    22-Jan-2021 01:37:52
...
out1 = t62.*(k.*t70.^2+(cmax.*t70.*(qd_t2.*(t31+t62)+qd_t5.*(t38+t61)+qd_t3.*t62+qd_t4.*t62+qd_t6.*t61+qd_t1.*(t2.*4.5018e-1+t31+t62)))./dmax)-Fx.*(sin(t20).*4.4835e-1+sin(t23).*4.5018e-1+(t47.*cos(q_t6+t23-atan(2.165415384615385)))./7.0368744177664e+18);
